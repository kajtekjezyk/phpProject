<?php
    ...
    {
        echo "Błąd: ".$db_connect->connect_errno;
    }
    else
    {
        $db_connect->query('SET NAMES utf8');
        $stacja = $_POST['stacja'];
        $result = @$db_connect->query("select * from tajemnice where nazwa like '%$stacja%'");
...
END;
        ...
        {
            echo "Błąd: nie ma takiej stacji";
        }
        elseif ($result->num_rows > 1)
        {
            echo "Błąd: za dużo stacji pasuje do wyszukania";
        }
    }
?>
